...
export default function BookSummaryCard(content:any) {
    ...
    //     while ((match = headingRegex.exec(bookData.content)) !== null) {
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span>{bookData.pubDatetime.toLocaleDateString("th-TH")}</span>
                                        </div>
                                    </div>
                                    {bookData.rating && <div className="pt-1">{renderRating(bookData.rating)}</div>}
                                </div>
                                {bookData.featured && (
                                    <Badge
                                        variant="secondary"
                            ...
                            {bookData.canonicalURL && (
                                <div className="pt-2">
                                    <Button variant="outline" size="sm" asChild className="group">
                                        <a href={bookData.canonicalURL} target="_blank" rel="noopener noreferrer">
                        ...
                        {bookData.ogImage && (
                            <div className="flex-shrink-0 lg:w-64">
                                <div className="relative mx-auto aspect-[3/4] w-full max-w-48 lg:max-w-none">
                                    <img
                                        src={bookData.ogImage || "/placeholder.svg?height=400&width=300"}
                                ...
                                <CardContent className="pt-6">
                                    <div
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: `<div class="space-y-4"><p class="mb-4 leading-7 text-foreground">${parseMarkdown(bookData.content)}</p></div>`,
                                        }}
                                    />
                                </CardContent>
                            </Card>
