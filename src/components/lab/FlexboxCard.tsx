...
export default function FlexboxCard() {
    ...
    const randomBoxSizes = Array.from({ length: boxCount }).map(() =>
        getRandomSize()
    )
    ...
    return (
        <div className="space-y-8">
            ...
            <div
                className={`grid grid-cols-${gridColumns} gap-4 p-6`}
                style={{
                    display: 'grid',
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div className="h-24 rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 p-4 text-white font-medium shadow-md">
                    Box 1
                </div>
                <div className="h-40 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 p-4 text-white font-medium shadow-md">
                    Box 2
                </div>
                <div className="h-32 rounded-lg bg-gradient-to-r from-emerald-500 to-green-600 p-4 text-white font-medium shadow-md">
                    Box 3
                </div>
                <div className="h-28 rounded-lg bg-gradient-to-r from-amber-500 to-yellow-500 p-4 text-white font-medium shadow-md">
                    Box 4
                </div>
                <div className="h-48 rounded-lg bg-gradient-to-r from-red-500 to-pink-600 p-4 text-white font-medium shadow-md">
                    Box 5
                </div>
                <div className="h-48 rounded-lg bg-gradient-to-r from-fuchsia-500 to-purple-600 p-4 text-white font-medium shadow-md">
                    Box 6
                </div>
            </div>
