...
=======
<span style={{ color: 'blue' }}>allowSendEmail:</span> สถานะการอนุญาตส่งอีเมล (true = อนุญาต, false = ไม่อนุญาต)

<span style={{ color: 'blue' }}>สร้างอาร์เรย์ employees:</span> เก็บข้อมูลพนักงานในรูปแบบ EmailPolicy
...
<span style={{ color: 'green' }}>กรณีที่ 1:</span> เปลี่ยนจากไม่อนุญาตเป็นอนุญาต -> เพิ่มข้อมูลพนักงานใน unCheckToCheck

<span style={{ color: 'green' }}>กรณีที่ 2:</span> เปลี่ยนจากอนุญาตเป็นไม่อนุญาต (เปลี่ยนกลับ) -> ลบข้อมูลพนักงานออกจาก unCheckToCheck

<span style={{ color: 'green' }}>กรณีที่ 3:</span> เปลี่ยนจากอนุญาตเป็นไม่อนุญาต -> เพิ่มข้อมูลพนักงานใน checkToUncheck

<span style={{ color: 'green' }}>กรณีที่ 4:</span> เปลี่ยนจากไม่อนุญาตเป็นอนุญาต (เปลี่ยนกลับ) -> ลบข้อมูลพนักงานออกจาก checkToUncheck
>>>>>>> bc768da (docs: move blog posts to new folders)
